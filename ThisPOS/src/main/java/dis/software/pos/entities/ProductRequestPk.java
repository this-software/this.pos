...
/**
 * Clase que contiene los campos de identidad para los productos solicitados
...
public class ProductRequestPk implements Serializable
{
    ...
    public boolean equals(Object o)
    {
        ...
        ProductRequestPk that = (ProductRequestPk) o;
    ...
    public String toString() {
        return "ProductRequestPk: " + this.product + ", " + this.unit;
    }
