...
/**
 * Clase encargada de procesar los correos de solicitudes de producto
 * @author Milton Cavazos
 */
public class ProductRequestMailProcessor implements Runnable
{
    ...
    public ProductRequestMailProcessor() {}
    
    /**
     * Constructor de la clase
     * @param productRequest Producto solicitado
     */
    public ProductRequestMailProcessor(ProductRequest productRequest)
    {
        this.productRequest = productRequest;
    }

    /**
     * Método para notificar a los usuarios correspondientes acerca de la SOLICITUD de producto
     */
    @Override
    public void run()
    {
        ...
        mailUtil.setSubject("Notificación: SOLICITUD de producto");
        
        StringBuilder content = new StringBuilder();
        content.append("El usuario (").append(ApplicationSession.getUser().getName()).append(") ")
            .append("ha generado una <b>SOLICITUD</b> de producto.<br><br>")
            ...
            .append("<b>Fecha de solicitud:</b> ").append((new SimpleDateFormat("dd 'de' MMMM 'del' yyyy, hh:mm a"))
