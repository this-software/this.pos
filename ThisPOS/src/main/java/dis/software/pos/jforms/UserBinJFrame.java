...
/**
 * Formulario para la visualización de usuarios eliminados
 * @author Milton Cavazos
 */
public class UserBinJFrame extends javax.swing.JInternalFrame
{
    
    private static final Logger logger = LogManager.getLogger(UserBinJFrame.class.getSimpleName());
    
    private TableRowSorter<UserTableModel> sorter;

    /**
     * Creación de nuevo formulario UserBinJFrame
     */
    public UserBinJFrame()
    {
        
        initComponents();
        
        IUser iUser = Application.getContext().getBean(IUser.class);
        UserTableModel userTableModel = new UserTableModel(iUser.getDeleted());
    ...
    private void delete()
    {
        ...
        if (OptionPane.showConfirmDialog(this,
            "¿Está seguro de que desea eliminar el registro de forma permanente?", " Eliminar registro",
