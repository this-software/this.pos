...
/**
 * Formulario para la visualización de productos eliminados
 * @author Milton Cavazos
 */
public class ProductBinJFrame extends javax.swing.JInternalFrame
{
    
    private final TableRowSorter<ProductTableModel> sorter;

    /**
     * Creación de nuevo formulario ProductBinJFrame
     */
    public ProductBinJFrame()
    {
        
        initComponents();
        
        IProduct iProduct = Application.getContext().getBean(IProduct.class);
        ProductTableModel productTableModel = new ProductTableModel(iProduct.getDeleted());
