...
/**
 * Formulario para la visualización de categorías eliminadas
 * @author Milton Cavazos
 */
public class CategoryBinJFrame extends javax.swing.JInternalFrame
{

    private final TableRowSorter<CategoryTableModel> sorter;
    
    /**
     * Creación de nuevo formulario CategoryBinJFrame
     */
    public CategoryBinJFrame()
    {
        
        initComponents();
        
        ICategory iCategory = Application.getContext().getBean(ICategory.class);
        CategoryTableModel categoryTableModel = new CategoryTableModel(iCategory.getDeleted());
    ...
    private void restore()
    {
        ...
        {
            OptionPane.showMessageDialog(this, "Selecciona un registro por favor.",
