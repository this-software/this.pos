...
public class InventoryIncomeJFrame extends javax.swing.JInternalFrame
{
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Entrada de productos a inventario");
        ...
        jlblHeader.setText("Entrada a inventario");
        ...
        jpanelBody.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(204, 204, 204), new java.awt.Color(153, 153, 153), null, null), "Información de inventario", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12))); // NOI18N
        ...
        jlblUnits.setText("* Unidades por entrar:");
        ...
        jbtnAddProduct.setMargin(new java.awt.Insets(2, 0, 2, 4));
        ...
        jbtnRemoveProduct.setMargin(new java.awt.Insets(2, 0, 2, 4));
            ...
            .addGroup(jpanelBodyLayout.createSequentialGroup()
                ...
                .addGroup(jpanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpanelBodyLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jbtnRemoveProduct, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jpanelBodyLayout.createSequentialGroup()
                        .addGroup(jpanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jscrollPaneTable, javax.swing.GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jbtnSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtnSaveMouseClicked
        ...
        {
            JOptionPane.showMessageDialog(this, "El registro de entrada se ha guardado exitosamente.");
        }
        else
        {
            JOptionPane.showMessageDialog(this, "Ha ocurrido un error al intentar guardar el registro de entrada.");
        }
