 ...
 */
public class ProfileBinJFrame extends javax.swing.JInternalFrame
{
    
    private final TableRowSorter<ProfileTableModel> sorter;

    /**
     * Creación de nuevo formulario ProfileBinJFrame
     */
    public ProfileBinJFrame()
    {
        
        initComponents();
        
        IProfile iProfile = Application.getContext().getBean(IProfile.class);
        ProfileTableModel profileTableModel = new ProfileTableModel(iProfile.getDeleted());
