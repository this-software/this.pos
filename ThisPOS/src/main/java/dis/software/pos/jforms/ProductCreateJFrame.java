...
public class ProductCreateJFrame extends javax.swing.JInternalFrame
{
    ...
    private void jbtnSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtnSaveMouseClicked
        ...
        product.setCreatedBy(ApplicationSession.getUser().getId());
        ...
        {
            JOptionPane.showMessageDialog(this, "El producto se ha guardado exitosamente.");
        }
        else
        {
            JOptionPane.showMessageDialog(this, "Ha ocurrido un error al intentar guardar el producto.");
        }
