...
public class ProviderViewJFrame extends javax.swing.JInternalFrame
{
    ...
    public ProviderViewJFrame()
    {
        ...
        ProviderTableModel providerTableModel = new ProviderTableModel(iProvider.findAll());
    ...
    private void edit()
    {
        ...
        Provider provider = providerTableModel.get(
            jtableProviders.convertRowIndexToModel(jtableProviders.getSelectedRow()));

        ProviderEditJFrame providerEditJFrame = new ProviderEditJFrame(provider);
        getDesktopPane().add(providerEditJFrame);
        providerEditJFrame.pack();
        try
        {
            providerEditJFrame.setMaximum(true);
        }
        catch (PropertyVetoException ex)
        {
            //logger.error("Error setting maximum", ex);
        }
        providerEditJFrame.setVisible(true);
